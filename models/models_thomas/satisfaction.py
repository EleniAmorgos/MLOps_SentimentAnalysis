...
comment = pd.read_csv('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/trustpilot_comment_retired.csv')
...
comment_0_1 = pd.read_csv('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/trustpilot_comment_retired_0_1.csv')
...
# contenu de la 2ème page
    ...
    if notation == "notation de 1 à 5":
        ...
        if selection_model_DL == "Embedding-lsmt":
            model = tf.keras.models.load_model('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/models/model_embedding_lstm')
            ...
            model = tf.keras.models.load_model('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/models/model_embedding_rnn')
            check_predict = model.predict(check_pad, verbose=1)
            check_predict_class = check_predict.argmax(axis=1)
            st.write("la note attribuée par le modèle est :")
            st.write(check_predict_class)
        ...
        if selection_model_DL == "Embedding-RNN-LTSM":
            model = tf.keras.models.load_model('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/models/Embedding_0_1_lstm')
            ...
            model = tf.keras.models.load_model('C:/Users/t.fourtouill/Bureau/streamlit_satisfaction_clients/models/Embedding_0_1_rnn')
            check_predict_0_1 = model.predict(check_pad_0_1, verbose=1)
            check_predict_class_0_1 = check_predict_0_1.argmax(axis=1)
            if check_predict_class_0_1==0:
                st.write('le commentaire est négatif')
